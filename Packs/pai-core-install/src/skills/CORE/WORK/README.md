...
**Highly Sensitive Work Content**

This directory contains work-related content including customer data, consulting engagements, client deliverables, and business-sensitive materials.
...
- Personal non-work content (use USER/)
