...
- `~/.claude/skills/_PAI/Workflows/CreatePack.md` - Uses this for icon generation
- `~/.claude/skills/_PAI/Workflows/ValidatePack.md` - Validates icon exists
- `~/.claude/skills/_PAI/Workflows/PAIIntegrityCheck.md` - Checks all icons
